<template>
  <section>
    ...
    <div class="d-flex flex-row m-t-16">
      <button class="m-r-8" @click="bootIntercom(user)"> Boot </button>
      <button class="m-r-8" @click="shutdownIntercom"> Shutdown </button>
      <button class="m-r-8" @click="hideIntercom"> Hide </button>
      <button class="m-r-8" @click="showIntercom"> Show </button>
    </div>
